package com.raptormm4.dinomod.entity.custom;
...
public class TriceratopsEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0, Ingredient.of(Items.OAK_SAPLING), false));
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(Items.OAK_SAPLING);
    }
